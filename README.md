...
- **[Indra](https://github.com/KyoriPowered/indra) and [Shadow](https://github.com/GradleUp/shadow) Plugin Integration**: Seamlessly integrates with Indra and Shadow plugins for advanced project
...
```groovy
plugins {
    id 'com.vouncherstudios.strawberry' version '2.0.0'
}
```
